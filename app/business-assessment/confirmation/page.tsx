          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2 flex flex-col justify-center">
              ...
              <p className="text-sm mb-6">
                Before you can proceed, please complete the business registration process to finalize your business.
              </p>
              <div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-6 bg-white/80 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Your business assessment is almost complete. Finalize your registration to access your dashboard.
                    </p>
                  </div>
                </div>
                <img
